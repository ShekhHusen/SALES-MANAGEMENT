...
import { Company, Model, BusinessProfile } from '@/types';
...
import { Trash2, Plus, ChevronDown, ChevronUp, KeyRound, Store } from 'lucide-react';
...
export function Settings() {
  ...
  const [newModel, setNewModel] = useState({ name: '', companyId: '', termsAndConditions: '', warrantyInfo: '', showBatteryDetails: false });
